...
/*       var that = this
  ...
  methods: {
    ...
    uploadHandle() {
      ...
      this.$nextTick(() => {
        this.$refs.upload.init(
          "/department/strategy/uploadExcel?createTime=" +
    ...
    uploadFile() {
      ...
      this.$nextTick(() => {
        this.$refs.upload.init(
          "/file/uploadFile?fileName=科研中心员工绩效考核评分表-战略"
        );
      });
    },
    downloadFile() {
      window.location.href = this.$http.adornUrl(
        "/file/downloadFile?fileName=科研中心员工绩效考核评分表-战略" +
          "&token=" +
    ...
    exportExcel() {
      ...
      window.location.href = this.$http.adornUrl(
        "/department/strategy/exportExcel?name=" +
          this.condition.name +
          "&createTime=" +
          this.condition.createTime +
          "&token=" +
