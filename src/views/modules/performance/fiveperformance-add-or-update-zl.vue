<template>
  <el-dialog
    ...
    <el-form-item label="工作量" prop="workload">
      ...
      <el-form-item label="先进性与创新性" prop="advanced" v-if="!isAuth('sys:performance:zlshenhe') && !isAuth('sys:performance:jrshenhe') && !isAuth('sys:performance:jsshenhe') && !isAuth('sys:performance:sjshenhe')">
        <el-input v-model="dataForm.advanced" placeholder="先进性与创新性"></el-input>
      </el-form-item>
    <el-form-item label="调查研究" prop="research" v-if="!isAuth('sys:performance:jrshenhe') && !isAuth('sys:performance:sjshenhe')">
      <el-input v-model="dataForm.research" placeholder="调查研究"  ></el-input>
    </el-form-item>
    <el-form-item label="进度管控" prop="process" v-if="!isAuth('sys:performance:sjshenhe')">
      <el-input v-model="dataForm.process" placeholder="进度管控"></el-input>
    </el-form-item>
    <el-form-item label="成果价值" prop="achievement" v-if="!isAuth('sys:performance:sjshenhe')">
      <el-input v-model="dataForm.achievement" placeholder="成果价值"></el-input>
    </el-form-item>
    <el-form-item label="承担科研项目评价" prop="evaluation" v-if="!isAuth('sys:performance:sjshenhe')">
