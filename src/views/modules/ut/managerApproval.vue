  ...
  >
    ...
    <el-form :model="dataForm"  ref="dataForm" @keyup.enter.native="dataFormSubmit()" v-loading="dataListLoading" >
      <el-table
        ...
        <el-table-column label="本周总工时" prop="weekTime" header-align="center"  width="100" align="center" ></el-table-column>
    ...
    methods: {
      ...
      dataFormSubmit () {
        ...
        this.$confirm(`确定审批吗?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl(`/approval/managerApprovalWorkTime`),
            method: 'post',
