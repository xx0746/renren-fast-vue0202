    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button  type="text" size="small" @click="addOrUpdateHandle(scope.row.id,scope.row.departmentName)">修改</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      exportExcel () {
        window.location.href = this.$http.adornUrl('/sys/user/export?token=' + this.$cookie.get('token'))
      },
      // 获取数据列表
      getDataList () {
      ...
      // 新增 / 修改
      addOrUpdateHandle (id, departmentName) {
        this.addOrUpdateVisible = true
        this.$nextTick(() => {
          this.$refs.addOrUpdate.init(id, departmentName)
        })
      },
      // 删除
      deleteHandle (id) {
